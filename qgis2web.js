...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [99.386551, 0.802481, 100.605658, 1.612718], maxZoom: 27, minZoom: 2, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [99.419297, 0.756667, 100.186389, 1.568763],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([99.386551, 0.802481, 100.605658, 1.612718], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_DataDesaDalamKabupatenPadangLawas_1,
    colName: 'PALAS_NAMO',
    zoom: 10,
    collapsed: true,
    map: map,
